...
class Settings(BaseSettings):
    ...
    jwt_given_name_param_name: str = "given_name"
    """Имя параметра для имени пользователя в jwt"""
    jwt_family_name_param_name: str = "family_name"
    """Имя параметра для фамилии пользователя в jwt"""
    jwt_full_name_param_name: str = "full_name"
    """Имя параметра для полного имени пользователя в jwt"""

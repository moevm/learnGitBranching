exports.strings = {
  ...
  'level-cant-exit': {
    ...
    'en_US': 'You are not in a level! You are in a sandbox"',
    'de_DE': 'Du bist nicht in einem Level! Du bist im Sandkasten-Modus, starte ein Level mit "levels"',
    'zh_CN': '您没在关卡中而是在沙盒中，要开始关卡请输入 ',
    'zh_TW': '您沒在關卡中！您在沙盒中，要開始關卡請輸入 ',
    'es_AR': '¡No estás en un nivel! Estás en el sandbox',
    'es_MX': '¡No estás en un nivel! Estás en el sandbox',
    'es_ES': '¡No estás en un nivel! Estás en el sandbox',
    'pt_BR': 'Você não está em um nível! Você está no sandbox,"',
    'gl'   : '¡Non estás en ningún nivel! Estás nunha caixa de arena"',
    'fr_FR': 'Vous n\'êtes pas dans un niveau ! Vous êtes dans le mode bac à sable"',
    'ru_RU': 'Ты не проходишь уровень! Ты в песочнице!',
    'uk': 'Ти не в рівні! Ти в пісочниці!"',
    'ko': '당신은 샌드박스에 있습니다',
    'vi': 'Bạn hiện không ở cấp độ nào cả! Bạn đang ở trong hộp cát (sandbox)"',
    'sl_SI': 'Nisi v stopnji! Si v peskovniku, začni',
    'pl'   : 'Nie jesteś na poziomie! Jesteś w trybie piaskownicy"',
    'it_IT':
      'Non ti trovi in un livello! Sei nella sandbox"',
  },
  ///////////////////////////////////////////////////////////////////////////
  'level-no-id': {
  ...
  'already-solved': {
    ...
    'en_US': 'You have already solved this level, try other levels or go back to sandbox with "sandbox"',
    'de_DE': 'Du hast dieses Level bereits gelöst, probier ein anderes Level aus oder geh in den Sandkasten-Modus mit "sandbox"',
    'zh_CN': '你已经解决了本关 尝试其他关卡，或者输入 "sandbox" 回到沙盒中',
    'zh_TW': '你已經解决了本關 嘗試其他關卡，或者輸入 "sandbox" 回到沙盒中',
    'es_AR': 'Ya resolviste este nivel, probá otros o volvé al sandbox usando "sandbox"',
    'es_MX': 'Ya resolviste este nivel, prueba otros o vuelve al sandbox usando "sandbox"',
    'es_ES': 'Ya resolviste este nivel, prueba otros o vuelve al sandbox usando "sandbox"',
    'pt_BR': 'Você já resolveu este nível, tente outros ou volte ao sandbox com "sandbox"',
    'gl'   : 'Xa resolviches este nivel, proba outros ou volve á caixa de area con "sandbox"',
    'fr_FR': 'Vous avez déjà résolu ce niveau, essayez d\'autres niveaux ou revenez au bac à sable avec "sandbox"',
    'ru_RU': 'Ты решил это задание, можешь пойти решить другие или в песочницу "sandbox"',
    'uk': 'Ти вже пройшов цей рівень, спробуй інші рівні чи повернись в пісочницю з "sandbox"',
    'ko': '당신은 이미 이 레벨을 해결했습니다. 사용하여 다른 레벨에 도전하거나 사용하여 샌드박스로 돌아가세요.',
    'vi': 'Bạn đã vượt qua cấp độ này. Thử cấp độ khác hoặc dùng "sandbox" để trở lại hộp cát',
    'sl_SI': 'To stopnjo si že rešil, poizkusi druge stopnje ali pojdi nazaj v peskovnik s "sandbox"',
    'pl'   : 'Już rozwiązałeś ten poziom, wypróbuj inne, lub wróć do trybu piaskownicy za pomocą polecenia "sandbox"',
    'it_IT':
      'Hai già risolto questo livello, prova altri livelli o torna alla sandbox con "sandbox"',
